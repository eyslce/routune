...
func TestRoutune_Shadowsocks(t *testing.T) {
...
func TestRoutune_ShadowsocksObfsHTTP(t *testing.T) {
	cfg := &container.Config{
...
func TestRoutune_ShadowsocksObfsTLS(t *testing.T) {
	cfg := &container.Config{
		Image: ImageShadowsocks,
		Env: []string{
			"SS_MODULE=ss-server",
...
func TestRoutune_ShadowsocksV2RayPlugin(t *testing.T) {
	cfg := &container.Config{
		Image: ImageShadowsocks,
		Env: []string{
			"SS_MODULE=ss-server",
